...
SET
    balance = balance + $1
WHERE
    id = $2 RETURNING id, owner, balance, created_at
`
...
VALUES
    ($1, $2, $3) RETURNING id, owner, balance, created_at
`
...
func (q *Queries) CreateAccount(ctx context.Context, arg CreateAccountParams) (Account, error) {
	row := q.db.QueryRowContext(ctx, createAccount, arg.ID, arg.Owner, arg.Balance)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.Owner,
...
SET
    ...
    balance = $3
WHERE
    id = $1 RETURNING id, owner, balance, created_at
`
